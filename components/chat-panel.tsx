...
export function ChatPanel({
  ...
  const exampleMessages = [
    ...
    },
    {
      ...
      subheading: 'MISK\'s leadership program?',
      message: 'How can I apply for MISK\'s leadership program?'
    },
    {
      heading: 'What events does MISK',
      subheading: 'have planned this month?',
      message: 'What events does MISK have planned this month?'
    }
  ]
